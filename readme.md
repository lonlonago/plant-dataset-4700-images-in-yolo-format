# Plant Dataset (4700 images in YOLO format

# Body

Plant pots dataset, 4700 images in YOLO format, with clear annotations, suitable for target detection, image segmentation, algorithm performance testing and other projects, complete data, ready to use, saves time and effort.
